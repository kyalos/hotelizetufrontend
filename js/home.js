	...
	result.all_hotels.forEach(element => {
		...
		<div class="w3-third w3-margin-bottom">
          <div class="w3-display-container w3-border">
            <img src="images/javahouse.png" id="malogo" alt="New York" style="width:100%" class="w3-grayscale-min w3-hover-sepia logos" onclick="window.location.href= 'branch.php?id=`+element.hotel_id+`'; storehotelid(`+element.hotel_id+`) ">
